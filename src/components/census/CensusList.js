...
useEffect(() => {
  ...
  return (
    <>
      ...
      <div className=" container flex flex-col md:m-auto before:relative overflow-auto shadow-md sm:rounded-lg shadow-sky-600/80 md:w-1/2 font-body border border-sky-600/20 py-6 px-4">
